...
const navbar = () => {
  ...
  if (user_id) {
      navbar.innerHTML = `
          ...
          <div class="relative inline-block text-left">
              ...
              <div class="dropdownMenu hidden absolute right-0 mt-2 w-40 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
                  <a href="/profile.html" class=" text-center block px-4 py-2 text-gray-700  font-bold hover:text-blue-600 transition">Profile</a>
                  <a href="/order.html" class=" text-center block px-4 py-2 text-gray-700 font-bold hover:bg-gray-100 hover:text-blue-600 transition">Order</a>
      ...
      navbar.innerHTML = `
          <a href="login.html" class="inline-flex items-center gap-2 bg-green-600 hover:bg-green-400 text-black px-4 py-2 rounded-md shadow">
              <img src="image/logout.svg" alt="Login Icon" class="w-6 h-6">
              <span>Login</span>
          </a>
          <a href="register.html" class="inline-flex items-center gap-2 bg-green-600 hover:bg-green-400 text-black px-4 py-2 rounded-md shadow">
              <img src="image/logout.svg" alt="Login Icon" class="w-6 h-6">
              <span>Register</span>
          </a>
      `;
